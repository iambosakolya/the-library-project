...
import type { RejectReasonDialogProps } from '../shared/types';
import { dialogHeaderStyles, formStyles } from './styles';
...
const RejectReasonDialog = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle className={dialogHeaderStyles.title}>
            <AlertTriangle className={dialogHeaderStyles.icon} />
            Reject Request
          </DialogTitle>
          <DialogDescription>
            {requestTitle
        ...
        <div className={formStyles.wrapper}>
          ...
          <Textarea
            ...
            rows={4}
            className={error ? formStyles.errorBorder : ''}
          />
