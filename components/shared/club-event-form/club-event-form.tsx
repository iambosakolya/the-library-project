    ...
    <Form {...form}>
      ...
      >
        ...
        {Object.keys(form.formState.errors).length > 0 && (
          <Card className={formStyles.errorCard}>
            <CardHeader>
              <CardTitle className={formStyles.errorTitle}>
            ...
            <CardContent>
              <ul className={formStyles.errorList}>
                {Object.entries(form.formState.errors).map(([key, error]) => (
                  <li key={key} className={formStyles.errorItem}>
        ...
        {/* Dates */}
        <div className={formStyles.dateGrid}>
          <FormField
            control={form.control}
            name='startDate'
            render={({
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <div className={formStyles.bookGrid}>
                  ...
                  return (
                    <Card
                      ...
                      className={`cursor-pointer transition-all ${
                        isSelected
                          ? formStyles.bookCardSelected
                          : formStyles.bookCardUnselected
                      }`}
                      onClick={() => {
                    ...
                    >
                      <CardContent className={formStyles.bookContent}>
                        <div className={formStyles.bookRow}>
                          ...
                          <div className={formStyles.bookInfo}>
                            <h4 className={formStyles.bookTitle}>{product.name}</h4>
                            <p className={formStyles.bookAuthor}>
                              by {product.author}
                            </p>
                          </div>
                        </div>
